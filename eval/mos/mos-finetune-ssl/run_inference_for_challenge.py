...
def main():
    ...
    ## 3. run inference
    os.system('python predict.py --fairseq_base_model fairseq/wav2vec_small.pt --outfile answer_%s.txt --finetuned_checkpoint pretrained/ckpt_w2vsmall --datadir '%(DATADIR.split('/')[-1]) + DATADIR)
